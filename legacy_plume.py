# %% [markdown]
# # heat flux and temperature copling for the interface, no back coupling
...
# assigner = fenics.FunctionAssigner(W.sub(2), VTa)
# assigner.assign(w_n.sub(2), T0_air)

# # velocity/pressure initial guess = 0
