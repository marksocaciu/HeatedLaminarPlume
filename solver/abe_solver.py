    ...
    for k, stage in enumerate(stages, start=1):
        ...
        if save_obj is not None:
            ...
            u_dim, p_dim, T_dim = dimensionalize_fields(
                ...
                save_obj[2].Uref_abe, save_obj[2].dTref, T_ambient,
...
def run_post_abe_continuation_transient(
    ...
    def _xdmf_time_seconds(t_value):
        ...
        try:
            velocity_scale = float(scales.Uref_abe if getattr(scales, "Uref_abe", None) is not None else scales.Uref)
