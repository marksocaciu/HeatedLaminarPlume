    ...
    for step in range(1, max_steps + 1):
        ...
        try:
            ...
            if dtau <= dtau_min * (1.0 + 1e-12):
                ...
                return w_n, info, F_steady, JF_steady, boundary_conditions, scales
        ...
        if stage_converged:
            ...
            copy_state(w, w_n)
            return w, info, F_steady, JF_steady, boundary_conditions, scales
...
def solve_ptc_temp_continuation(
    experiment: Experiment,
    W: fenics.FunctionSpace,
    w: fenics.Function,
    w_n: fenics.Function,
...
def run_post_temp_continuation_transient(
    experiment: Experiment,
    fluid_material: TemperatureDependentMaterial,
    W: fenics.FunctionSpace,
    w: fenics.Function,
