...
//BooleanFragments{ Surface{1}; Delete; }{ Surface{2}; Curve{7}; Delete; }
...
Physical Curve(101) = {1, 2, -3, 4, 5, -6};   // outer boundary of air domain

// Wire-air interface
Physical Curve(102) = {7};            // outer boundary of wire domain
...
Transfinite Line{7}  = resolution * 2.5;

// Outer
Transfinite Line{1}  = resolution * 0.2;
Transfinite Line{2}  = resolution * 0.3;
Transfinite Line{3}  = resolution * 0.2;
Transfinite Line{4}  = resolution * 0.2;
Transfinite Line{5}  = resolution * 0.3;
Transfinite Line{6}  = resolution * 0.2;
